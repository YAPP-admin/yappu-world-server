...
data class AdminSignUpApplicationOverviewAppResponseDto(
    ...
    val activityUnit: ActivityUnitParam,
    ...
    constructor(application: SignUpApplication) : this(
        ...
        activityUnit = application.details.activityUnits.maxBy { it.generation },
