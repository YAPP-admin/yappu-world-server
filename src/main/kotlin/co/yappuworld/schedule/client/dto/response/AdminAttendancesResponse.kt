...
data class AdminAttendancesResponse(
    ...
    @field:Schema(description = "유저 목록")
    val users: List<AdminAttendanceUserResponse>,
    @field:Schema(description = "세션별 출석 정보")
...
data class AdminAttendanceSessionResponse(
    ...
    @field:Schema(description = "세션 종료일")
    ...
    @field:Schema(description = "총 인원")
    val totalPersonCount: Int,
    @field:Schema(description = "출석 인원")
    val totalOnTimeCount: Int,
    @field:Schema(description = "지각 인원")
    val totalLateCount: Int,
    @field:Schema(description = "결석 인원")
    val totalAbsentCount: Int,
    @field:Schema(description = "조퇴 인원")
    val totalEarlyCheckOutCount: Int,
    @field:Schema(description = "공결 인원")
